...
//    var parentTag = document.querySelector('.copyright')
//    var textBox = document.createElement('input')
//    console.log(parentTag + "   " + textBox)
//    element.insertBefore(parentTag, textBox)
//    }
//var btn = document.querySelector("#share-button");
//btn.onclick = copyUrlBox;
// working on a copy button, not working yet, linked to the fa link in footer.html
